...
RUN apt-get install -y varnish varnish-dev make && apt-get clean
RUN curl https://download.varnish-software.com/varnish-modules/varnish-modules-0.12.1.tar.gz -o varnish-modules-0.12.1.t
ar.gz  &&  \
